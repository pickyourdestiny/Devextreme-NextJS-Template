...
export async function signInCallback(user, account) {
...
export async function registerProvider(user, provider) {
...
export async function registerCredentials(formData) {
  ...
  await signIn("signin", {
    ...credentials,
    redirectTo: "/auth/registerProcess",
  });
}
...
export async function checkSession() {
  ...
  //this is a good place to retrieve user profile information.

  // const {name,email}==session.user
  // const userProfile= await retrieveDBUserProfile(email)
  // return userProfile
...
export async function changePassword(newPassword, recoveryCode) {
  try {
